...
If you are currently using PancakeSwap MasterChef (), you will need to migrate to the new contract ().
Overview
Deposit 
If you are currently using the enterStaking(uint256 _amount) on the current PancakeSwap MasterChef. You need to migrate to the new CAKE pool contract. Check out the related documentation .
...
Withdraw
If you are currently using the leaveStaking(uint256 _amount) on the current PancakeSwap MasterChef. You need to migrate to the new CAKE pool contract. Check out the related documentation .
